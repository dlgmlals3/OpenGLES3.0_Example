...
extern "C" {
    JNIEXPORT void JNICALL Java_com_example_opengles_GLESNativeLib_init(JNIEnv * env, jobject obj, jstring FilePath);
    JNIEXPORT void JNICALL Java_com_example_opengles_GLESNativeLib_resize(JNIEnv * env, jobject obj, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_example_opengles_GLESNativeLib_step(JNIEnv * env, jobject obj);
};
